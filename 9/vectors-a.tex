 ...
 \begin{tikzpicture}
  \begin{scope}[scale=1.5]
   ...
   \begin{scope}[shift={(0,0)}]
    ...
    \draw[fill=blue](0,0) circle(0.07) ++(-0.4,+0.0) node[blue]{$[\hspace{2pt}]$};
    \draw(0,-0.2) node{$A$};
    \draw(1,-0.2) node{$B$};
   ...
   \begin{scope}[shift={(2.75,0)}]
    ...
    \begin{scope}[shift={(1,0)}]
     ...
     \end{scope}
    \end{scope}
    \draw[fill=blue](0,0) circle(0.07) ++(-0.25,+0.0) node[blue]{$[\hspace{2pt}]$};
     ...
     \begin{scope}[blue]
      ...
      \begin{scope}[shift={(20:1)}]
       \begin{scope}[red]
        ...
        \drawThree{+0.25}{-1.0 }{right}{1}{6}{8}
       \end{scope}
      \end{scope}
