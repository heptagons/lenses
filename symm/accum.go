...
//	y3           = sin(3ω)                     = 0.866.. : h3
func accumOrigin9(X, Y []int) bool {
	...
	if accumAllEqual(Y[1], -Y[2], +Y[4]) == false {
		return false
	}
	return true
}
...
// cos(5ω)                     = 0.500
func accumOrigin15(X, Y []int) bool {
	// X
