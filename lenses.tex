...
Stars are polygons with a pair number of sides and defined by three numbers: A symmetry number and a pair of angles multiples of the symmetry. The symmetry angle is defined as $\omega = \dfrac{2\pi}s$ where $s$ is the symmetry number.
