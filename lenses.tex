...
\caption{Stars $S_7(2,4)$ and $S_7(3,3)$ dissected with only lenses (\mathbi{D},\mathbi{E},\mathbi{F}).}
...
\caption{Stars $S_7(1,5)$, $S_7(2,4)$ and $S_7(3,3)$ dissected with octagon \mathbi{$O_7$} (in blue) and lenses (\mathbi{D},\mathbi{E},\mathbi{F}).}
